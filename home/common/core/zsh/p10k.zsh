...
# Generated by Powerlevel10k configuration wizard on 2023-03-06 at 19:59 CET.
...
# 24h time, angled separators, sharp heads, slanted tails, 1 line, sparse, many icons,
...
() {
  ...
  if [ $TERM = 'xterm-kitty' ]; then
    # Alacritty doesn't support combining characters. Use a space instead.
